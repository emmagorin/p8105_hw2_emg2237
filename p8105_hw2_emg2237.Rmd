...
**The "Mr. Trash Wheel" datasets includes information about trash collected by "Mr. Trash Wheel" - a garbage collection machine on the Baltimore waterfront as well as monthly precipitation. There are (r code) observations in the Mr. Trash Wheel dataset (one per dumpster), and (r code) observations in the precipitation dataset (one per month from 2017-2018.) Key variables in the Mr. Trash Wheel dataset include the weight and volume of the dumpsters and trash items collected. The precipitation datasets included monthly precipitation in inches. The total precipitation in 2018 was (r code). The median number of sports balls in a dumpster in 2017 was (r code).**
